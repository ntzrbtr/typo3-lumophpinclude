# -*- coding: utf-8 -*-
#
# LumoNet PHP Include documentation build configuration file, created by
# TYPO3 extension sphinx on Wed, 02 Dec 2015 23:51:20 +0100.
#
...
htmlhelp_basename = 'lumophpincludedoc'
...
latex_documents = [
    ('Index', 'lumophpinclude.tex', u'LumoNet PHP Include',
     u'Thomas Off', 'manual'),
]
...
pdf_documents = [
    ('Index', 'lumophpinclude', u'LumoNet PHP Include',
     u'Thomas Off'),
]
...
texinfo_documents = [
    ('Index', 'lumophpinclude', u'LumoNet PHP Include',
     u'Thomas Off', 'LumoNet PHP Include', 'One line description of project.',
     'Miscellaneous'),
]
